...
import { Plus, Search, Filter, BookOpen, Users, Clock, MapPin, Video, Building } from 'lucide-react'
...
export default function AdminCoursesPage() {
  ...
  useEffect(() => {
    filterCourses()
  }, [courses, searchTerm, categoryFilter, levelFilter, deliveryFilter])
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-2">Manage courses, lessons, and delivery methods</p>
        </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => window.open(`/admin/courses/${course.id}/lessons`, '_blank')}
                    className="flex-1"
                  >
                    Lessons
                  </Button>
