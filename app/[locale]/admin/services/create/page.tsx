...
import { ServiceCenterHead, SERVICE_CATEGORIES } from '@/lib/services';
...
export default function CreateServicePage() {
  ...
  const handleSave = async (isDraft = false) => {
    ...
    try {
      ...
      await apiClient.createAdminService({
        ...serviceData,
      ...
      toast({
        title: 'Success',
        description: `Service ${isDraft ? 'saved as draft' : 'created'} successfully`,
      });
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Add a new service to the EPRI catalog</p>
              </div>
            </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              <CardHeader className="">
                ...
                <CardDescription>
                  List the main features and benefits of this service
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader className="">
                ...
                <CardDescription>
                  Create custom tabs with additional information about your service
                </CardDescription>
              </CardHeader>
              <CardContent>
