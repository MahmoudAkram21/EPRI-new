    ...
    <PageContainer>
      ...
      <Section className="relative overflow-hidden rounded-3xl border border-slate-200/80 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-6 py-20 text-white shadow-2xl dark:border-slate-700">
        ...
        <div className="relative z-10 mx-auto max-w-6xl text-center">
          ...
          <p className="mx-auto max-w-3xl text-lg leading-relaxed text-white/90 sm:text-xl mb-8">
            Managing intellectual property rights, patents, trademarks, and protecting research innovations.
          </p>
        </div>
      </Section>
      ...
      <Section>
        <div className="space-y-8">
          <Card>
            <CardHeader>
              <CardTitle>Intellectual Property Management</CardTitle>
              <CardDescription>
                Comprehensive IP management services for protecting and commercializing innovations.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-slate-600 dark:text-slate-300">
                Content for IP Management page...
              </p>
            </CardContent>
          </Card>
        </div>
