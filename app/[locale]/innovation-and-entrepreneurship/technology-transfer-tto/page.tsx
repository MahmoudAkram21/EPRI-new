...
import { Lightbulb, ArrowRight, Users, Target, FileText } from "lucide-react"

export default function TechnologyTransferTTOCPage() {
    ...
    <PageContainer>
      ...
      <Section className="relative overflow-hidden rounded-3xl border border-slate-200/80 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-6 py-20 text-white shadow-2xl dark:border-slate-700">
        ...
        <div className="relative z-10 mx-auto max-w-6xl text-center">
          ...
          <p className="mx-auto max-w-3xl text-lg leading-relaxed text-white/90 sm:text-xl mb-8">
            Facilitating the transfer of research innovations and technologies from the laboratory to industry and market.
          </p>
        </div>
      </Section>
      ...
      <Section>
        <div className="space-y-8">
          <Card>
            <CardHeader>
              <CardTitle>Technology Transfer Office</CardTitle>
              <CardDescription>
                Our Technology Transfer Office (TTO) serves as a bridge between research and industry.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-slate-600 dark:text-slate-300">
                Content for Technology Transfer TTO page...
              </p>
            </CardContent>
          </Card>
        </div>
