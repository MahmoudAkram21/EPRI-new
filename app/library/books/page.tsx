...
const booksData: Book[] = [
  {
    ...
    coverImage: "/book-covers/petroleum-engineering.jpg",
  ...
  },
  {
    ...
    coverImage: "/book-covers/reservoir-characterization.jpg",
    category: "Geology",
    year: 2022,
  ...
  },
  {
    ...
    coverImage: "/book-covers/sustainable-energy.jpg",
    category: "Energy",
    year: 2024,
  ...
  },
  {
    ...
    coverImage: "/book-covers/drilling-technology.jpg",
    category: "Engineering",
    year: 2023,
  ...
  },
  {
    ...
    coverImage: "/book-covers/refining-processes.jpg",
    category: "Chemistry",
    year: 2022,
  ...
  },
  {
    ...
    coverImage: "/book-covers/environmental-impact.jpg",
  ...
  },
  {
    ...
    coverImage: "/book-covers/well-completion.jpg",
    category: "Engineering",
    year: 2023,
  ...
  },
  {
    ...
    coverImage: "/book-covers/petroleum-economics.jpg",
    category: "Economics",
    year: 2022,
      ...
      <Section className="relative overflow-hidden rounded-3xl border border-slate-200/80 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-6 py-20 text-white shadow-2xl dark:border-slate-700">
        <div className="absolute inset-0 opacity-40">
          <img
            ...
            alt="Books collection background"
