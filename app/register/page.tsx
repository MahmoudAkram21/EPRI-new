...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const errorMessage = validateUserRegister(formData);
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-md mx-auto">
            <div className="text-center mb-8">
              <h1 className="font-serif text-4xl font-bold mb-4">Create Account</h1>
              <p className="text-muted-foreground">Join EPRI and start your learning journey today</p>
            </div>
