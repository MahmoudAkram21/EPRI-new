...
export default function CreateServiceCenterPage() {
  ...
  const handleSave = async (asDraft: boolean = false) => {
    ...
    try {
      ...
      await apiClient.createAdminServiceCenter(centerData);
      toast({
        title: 'Success',
        description: 'Service center/unit created successfully',
      });
      router.push('/admin/service-centers');
    } catch (error: any) {
      toast({
        title: 'Error',
        description: error.message || 'Failed to create service center/unit',
        variant: 'destructive',
      });
    } finally {
      setLoading(false);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900">Create New Center/Unit</h1>
                <p className="text-sm text-gray-500">Add a new service center or unit</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              >
                ...
                {loading ? 'Creating...' : 'Create Center/Unit'}
              </Button>
            </div>
          </div>
        </div>
