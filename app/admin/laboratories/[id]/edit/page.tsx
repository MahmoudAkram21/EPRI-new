...
export default function EditLaboratory() {
  ...
  const fetchLaboratory = async () => {
    try {
      const data = await apiClient.getLaboratory(params.id as string);
      ...
      setFormData({
        ...
        head_title: lab.head_title || '',
        head_academic_title: lab.head_academic_title || '',
        head_picture: lab.head_picture || '',
        head_cv_url: lab.head_cv_url || '',
        head_email: lab.head_email || '',
        head_bio: lab.head_bio || '',
        address: lab.address || '',
        phone: lab.phone || '',
        ...
        email: lab.email || '',
        website: lab.website || '',
        established_year: lab.established_year?.toString() || '',
        ...
        staff_count: lab.staff_count?.toString() || '0',
        students_count: lab.students_count?.toString() || '0',
        ...
        display_order: lab.display_order?.toString() || '0'
      });
    } catch (error: any) {
      console.error('Error fetching laboratory:', error);
      toast({
        title: "Error",
        description: error.message || "Failed to fetch laboratory details",
        variant: "destructive",
      });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await apiClient.updateLaboratory(params.id as string, formData);
      toast({
        title: "Success",
      ...
      toast({
        title: "Error",
        description: error.message || "Failed to update laboratory",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
    ...
    return (
      <div className="container mx-auto p-6">
        <div className="text-center py-12">
          ...
          <p>Loading laboratory details...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto p-6 max-w-4xl">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">Update laboratory information</p>
        </div>
      </div>
